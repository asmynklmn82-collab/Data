...
class PayPal:
    ...
    def Key(self):
        try:
            ...
            r1 = self.r.get(f'https://{self.url}{self.inurl}', headers=he1, timeout=15)
    ...
    def Krs(self, ccx):
        try:
            ...
            r2 = self.r.post(f'https://{self.url}/wp-admin/admin-ajax.php', headers=he2, data=da1, timeout=15)
            ...
            r3_json = self.r.post(f'https://{self.url}/wp-admin/admin-ajax.php', params=pa1,headers=he3,data=da2, timeout=15).json()
            r3 = r3_json['data']['id']
            he4 = {
            ...
            r4 = self.r.post(f'https://cors.api.paypal.com/v2/checkout/orders/{r3}/confirm-payment-source', headers=he4, json=da3, timeout=15)
            ...
            r5 = self.r.post(f'https://{self.url}/wp-admin/admin-ajax.php', params=pa2,headers=he5, data=da4, timeout=15)
            text = r5.text
